...
const AssessmentWizard: React.FC<AssessmentWizardProps> = ({ onComplete, onCancel }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 sm:py-12 md:py-20 px-4">
      {currentIndex === 0 && (
        <div className="mb-8 sm:mb-12 md:mb-16 p-6 sm:p-8 glass-card border-none rounded-none border-l-4 border-[#C5A059] text-center md:text-left">
      ...
      <div className="mb-8 sm:mb-12">
        <div className="flex justify-between items-end mb-4 sm:mb-6">
          <button
            onClick={handleBack}
            className="text-zinc-500 hover:text-[#C5A059] transition-all text-xs sm:text-[10px] font-bold uppercase tracking-[0.2em] focus:outline-none focus:ring-2 focus:ring-[#C5A059] focus:ring-offset-2 focus:ring-offset-black rounded touch-manipulation py-2 px-1"
            aria-label={
          ...
          <div className="text-right">
            <span className="text-[#C5A059] text-xs sm:text-[10px] font-bold uppercase tracking-[0.3em]">
              Step {currentIndex + 1}
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:gap-6" role="radiogroup" aria-labelledby="question-text">
          {currentQuestion.options.map(option => (
            <button
              ...
              className="w-full text-left p-6 sm:p-8 border border-white/5 hover:border-[#C5A059]/50 hover:bg-white/5 transition-all group flex justify-between items-center focus:outline-none focus:ring-2 focus:ring-[#C5A059] focus:ring-offset-2 focus:ring-offset-black touch-manipulation min-h-[60px]"
              role="radio"
            ...
            >
              ...
              <div
                className="w-5 h-5 sm:w-4 sm:h-4 rounded-full border-2 border-zinc-700 group-hover:border-[#C5A059] transition-colors flex-shrink-0"
                aria-hidden="true"
              />
            </button>
          ))}
      ...
      <p className="mt-8 sm:mt-12 text-center text-zinc-600 text-[10px] uppercase tracking-[0.4em]">
