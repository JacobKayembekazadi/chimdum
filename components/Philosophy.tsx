...
const Philosophy: React.FC<PhilosophyProps> = ({ onStartAssessment }) => {
  return (
    <div className="max-w-5xl mx-auto py-12 sm:py-16 md:py-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-12 sm:mb-16 md:mb-24">
      ...
      <div className="bg-[#0a0a0a] border border-white/5 p-8 sm:p-10 md:p-12 text-center">
        ...
        <p className="text-zinc-500 mb-6 sm:mb-8 md:mb-10">- Dr. Chimdum</p>
        <button
          onClick={onStartAssessment}
          className="px-8 sm:px-10 py-4 sm:py-5 bg-[#C5A059] text-black font-bold uppercase tracking-widest hover:bg-white transition-all touch-manipulation min-h-[48px] text-sm sm:text-base"
        >
          Check Your Body Now
        </button>
      </div>
