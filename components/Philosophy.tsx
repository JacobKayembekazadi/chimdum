...
const Philosophy: React.FC<PhilosophyProps> = ({ onStartAssessment }) => {
  return (
    <div className="max-w-6xl mx-auto py-12 sm:py-16 md:py-20 px-4 sm:px-6">
      {/* Hero Section */}
      <section
        className="text-center mb-16 sm:mb-20 md:mb-24 animate-fade-in-up"
        aria-labelledby="philosophy-title"
      >
        <h1
          id="philosophy-title"
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 sm:mb-10 italic px-2"
        >
          Our Way of Thinking
        </h1>
      ...
      <section
        className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 mb-20 sm:mb-24 md:mb-28"
      ...
      >
        ...
        <article className="glass-card p-8 sm:p-10 md:p-12 border-l-4 border-[#C5A059] group hover:border-[#F1D391] transition-all duration-300 animate-fade-in-up stagger-1">
          <div
            className="w-12 h-12 gold-bg rounded-full flex items-center justify-center text-black font-bold text-lg mb-6 shadow-[0_0_20px_rgba(197,160,89,0.3)]"
            aria-hidden="true"
          >
            01
          </div>
      ...
      <section
        className="glass-card p-10 sm:p-12 md:p-16 text-center relative overflow-hidden animate-fade-in-up stagger-3"
      ...
      >
        ...
        <div className="relative z-10">
          <blockquote>
            <h2
              id="cta-title"
              className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6 sm:mb-8 px-2 italic"
            >
              &quot;Nature is the best teacher.&quot;
            </h2>
            <cite className="text-zinc-400 mb-8 sm:mb-10 md:mb-12 text-base sm:text-lg font-light not-italic block">
              - Dr. Chimdum
            </cite>
          </blockquote>
          <button
